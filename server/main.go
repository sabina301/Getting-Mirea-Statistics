...
func main() {
	...
	number := 228                      // номер в группе (начиная с 0)
	email := "anonim.a.a@edu.mirea.ru" // почта
	password := "anonim"               // пароль
	...
	for _, node := range nodes {
		...
		key, _ := userNodes[number].Attribute("data-row-key")
